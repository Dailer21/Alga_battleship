...
public class UnCliente implements Runnable {
    ...
    final String[] comandos = {"HELP", "JUGADORES", "GANADORES", "BATTLESHIP nombreCliente", "TABLERO nombreCliente", "BATTLE nombreCliente coordenada", "RENDIRSE nombreCliente"};
    ...
    private void Partida(String clienteAJugar) {
        ...
        for (UnCliente cliente : ServidorB.lista.values()) {
            if (clienteAJugar.equals(cliente.nombre)) {
                ...
                // Aqui se asigna quien es el primer turno "true"
